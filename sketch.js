...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(CGRosa.isTouching(ciclistaPrincipal)){
    ...
    text("Aperte a tecla direcional para cima para reiniciar o jogo!",400,230);
 ...
 ciclistaPrincipal.addAnimation("SahilRunning",img2CiclistaPrincipal);
  ...
  if(keyDown("up")&&estadoJogo === ENCERRAMENTO){
  reset();
  }
  }
}
function reset(){
    ...
    ciclistaPrincipal.setAnimation("SahilRunning",img1CiclistaPrincipal);
